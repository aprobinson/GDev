...
//! \brief  Display PNG images with SDL_image
//! 
//---------------------------------------------------------------------------//
...
// displayed PNG image
SDL_Surface* g_png_surface = NULL;
...
bool loadMedia( const std::string& filename )
{
  ...
  // Load PNG surface
  g_png_surface = loadSurface( filename );
  
  if( g_png_surface == NULL )
  {
