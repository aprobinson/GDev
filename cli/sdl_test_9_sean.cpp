//---------------------------------------------------------------------------//
//!
//! \file   sdl_test_9_sean.cpp
//! \author Sean Robinson
//! \brief  Using Viewports
//! 
//---------------------------------------------------------------------------//
...
int main( int argc, char** argv )
{
  ...
  else
  {
	...
	// Create viewport for top left corner
	...
	// Create viewpoint for the top right corner
	...
	// Create viewpoint for the bottom
